...
metadata = load_metadata('../image_bt4')
...
#Xem nguoi 140
jc_orig = load_image(metadata[120].image_path())
...
show_pair(22, 50)
show_pair(300, 301)
#xem người 22 và 200 (22 và 200 là 2 người khác nhau)
#Xem 2 người khác nhau
show_pair(22, 150)
show_pair(300, 400)
...
filename_test = '../test/BanNguyen_0020.bmp'
...
mydict = ['BanChien','BanChinh','BanChuong','BanDu','BanDuy','BanHue','BanHung','BanKhue','BanMChien','BanNguyen','BanNinh','BanPhat','BanQui','BanThanh',
'BanThien','BanThinh','BanTin','BanTinh','BanTruc','BanTruong','BanTuan19','BanTuan20','BanTung','BanTuyen','BanVy','ChiHien','ThayDuc']
